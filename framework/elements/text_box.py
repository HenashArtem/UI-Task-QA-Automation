...
class TextBox(BaseElement):
    ...
    def get_value(self):
        ...
        Logger.info("get_value method on element " + self.get_name() + " " + self.get_element_type() +
                    " got the value: " + str(value))
        return value

    def clear_field(self):
        Logger.info("Removing text in an element " + self.get_name() + self.get_element_type() + "'" +
                    self.get_name() + "'")
    ...
    def selenium_clear(self):
        self.click()
        Logger.info("Clearing an element " + self.get_name() + self.get_element_type() + "'" + self.get_name() + "'")
