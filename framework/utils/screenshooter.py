...
class Screenshooter:
    ...
    def set_session_screen_dir():
        ...
        try:
            if not os.path.exists(Screenshooter.__screen_dir):
                Logger.info("Creating a directory for saving screenshots: " + Screenshooter.__screen_dir)
            ...
            Logger.info("Directory creation " + new_screen_path)
    ...
    def take_screenshot():
        ...
        Logger.info("Taking a screenshot of the screen to a file " + screen_name)
